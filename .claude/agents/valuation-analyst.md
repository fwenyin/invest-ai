...
tools: Read, mcp__to-the-moon-data__get_fundamentals, mcp__to-the-moon-data__get_quote, mcp__to-the-moon-data__get_company_news, WebSearch
---
...
1. Pull `get_fundamentals` for the base numbers (multiples, FCF yield, margins, growth, net debt),
   then use WebSearch to refine current financials (revenue, FCF, EPS, growth, net debt, share count) and consensus.
